...
from dataAnalysis import plot_ridgepin_shape, fit_function_new, import_data_from_file, normalize_data, matplot_plotting
...
def fitness_func(ga_instance, 
    ...
    fitness_value = fit_function_new(file_name=final_filename,debug=False, max_error=False, sqrt_fit_val=True)
